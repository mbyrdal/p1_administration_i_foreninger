 ...
 * amount_of_options: Input parameter. Antallet af muligheder brugeren kan vælge i mellem.
 ...
 * Returnerer 1 hvis answer er 'j', -1 hvis answer er 'n', eller 0, hvis answer hverken er 'j' eller 'n'.
 */
