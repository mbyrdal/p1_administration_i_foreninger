 ...
 * tasks[]: Input/output parameter. Arrayet får tilføjet et element.
 * categories[][]: Input/output parameter. Arrayet sendes videre til funktionen prompt_for_category().
 * number_of_tasks: Input/output parameter. Tælles én op, da der tilføjes en opgave.
 * number_of_categories: Input/output parameter. Parameteren sendes videre til funktionen prompt_for_category().
 ...
 * tasks[]: Input/output parameter. Et element i dette array skal ændres.
 * categories[][]: Input/output parameter. Arrayet sendes videre til funktionen prompt_for_category().
 * number_of_tasks: Input parameter. Parameteren sendes videre til til funktionen prompt_for_category().
 * number_of_categories: Input/output parameter. Parameteren sendes videre til til funktionen prompt_for_category().
 ...
 * tasks[]: Input/output parameter. Et element i dette array får sin kategori ændret.
 * categories[][]: Input/output parameter. Alle kategorier printes. Arrayet sendes vider til funktionerne add_category() og edit_category().
 * number_of_tasks: Input parameter. Parameteren sendes videre til funktionen edit_category().
 * number_of_categories: Input/output parameter. Brugestil at printe alle kategorier. Parameteren sendes videre til funktionen add_category().
 * index: Input parameter. Index til opgaven, der skal ændres i tasks[].
 * Returnerer ikke noget.
 */
 ...
 * categories[][]: Input/output parameter. Der tilføjes et element til dette array.
 * number_of_categories: Input/output parameter. Parameteren tælles én op, da der tilføjes et element i categories[][].
 * Returnerer ikke noget.
 */
 ...
 * tasks[]: Input/output parameter. Alle elementer i tasks[] men en bestemt kategori, skal have ændret denne kategori til den nye kategori.
 * categories[][]: Input/output parameter. En eksisterende kategori i dette array ændres.
