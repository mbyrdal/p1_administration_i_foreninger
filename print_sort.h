...
/* Funktionen kalder på funktionerne sort_tasks() og print_sort() efter brugeren har valgt sortering.
 * tasks[]: Input/output parameter. Arrayet sendes videre til funktionerne sort_tasks() og print_sort().
 ...
 * tasks[]: Input/output parameter. Arrayet sorteres efter den valgte sortering.
 ...
 * option: Input parameter. Den valgte sortering afgør, hvordan tasks[] bliver printet.
 * Returnerer ikke noget.
 */
