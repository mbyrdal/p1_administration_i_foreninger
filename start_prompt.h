...
/* Funktion, som kører startprompten af programmet.
 * tasks[]: Input\output parameter. Arrayet sendes videre til funktionen file_managing().
 * categories[][]: Input\output parameter. Arrayet sendes videre til funktionen file_managing().
 * number_of_tasks: Input\output parameter. Parameteren sendes videre til funktionen file_managing().
 * number_of_categories: Input\output parameter. Parameteren sendes videre til funktionen file_managing().
 * file_name: Input\output parameter. Parameteren sendes videre til funktionen file_managing().
 ...
 * user_input: Input\output parameter. Brugerens input gemmes i denne variabel.
 * Returnerer ikke noget.
 */
void file_input(char *print, char *user_input);

/* Funktion, som opretter en mappe, hvis den ikke eksisterer og ellers åbnes, hvis mappen eksisterer. 
 * dir_name: Input\output parameter. Der tjekkes om en given mappe eksisterer. Hvis ikke oprettes denne mappe, hvis brugeren ønsker det.
 * Returnerer ikke noget.
 */
void create_dir(char *dir_name);

/* Funktion, som gør brug af boolsk logik til at afgøre, om en mappe eksisterer.
 ...
 * tasks[]: Input\output parameter. Arrayet sendes videre til funktionen file_read_task() eller til sig selv, hvis den kaldes rekursivt.
 * categories[]: Input\output parameter. Arrayet sendes videre til funktionen category_read().
 * number_of_tasks: Input\output parameter. Parameteren sendes videre til funktionen file_read_task() og tæller number_of_tasks én op.
 * number_of_categories: Input\output parameter. Parameteren sendes videre funktionen category_read().
 ...
 * file: Input parameter. Filen der skrives til.
 ...
 * file: Input parameter. Filen der læses fra.
 * task1: Input/output parameter. Opgaven der skrives til. 
 * Returnerer ikke noget.
 */
void file_read_task(FILE *file, task *task1);

/* Funktionen opretter en fil og skriver alle opgaver og kategorier ind i filen.
 ...
 * file: Input parameter. Filen der skal læses fra.
 * categories[][]: Input\output parameter. Indlæste kategorier skrives til dette array.
 * number_of_categories: Input\output parameter. Tælles op for hver kategori der læses.
 * Returnerer ikke noget.
 */
